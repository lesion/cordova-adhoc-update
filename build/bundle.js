...
/***/ function(module, exports, __webpack_require__) {
	...
	var _semver = __webpack_require__(1);
	...
	exports.default = {
	  ...
	  update: function update() {
	    var ios = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
	  ...
	  check: function check(data) {
	    ...
	    return fetch(this.update_url).then(function (response) {
	      ...
	      console.error(_this);
	      _this.release_url = last_release.url;

	      return (0, _semver.gt)(last_release.release, _this.current_release) ? last_release : false;
	    });
	  }
	};
